...
<script src="../assets/js/vendors/highcharts.js"></script>
				...
				<?php
					$query = "SELECT COUNT(VC.Domain_Name), SUM(CASE WHEN VC.SSL_Days_Left < 0 THEN 1 ELSE 0 END) FROM view_cron VC INNER JOIN domain_data DD ON DD.Domain_Name = VC.Domain_Name WHERE DD.UserID = ?;";
